import{P as L}from"./prism-tomorrow-D4rolk58.js";import{U as t,a as B,n as N,k as v,o as s,c as n,h as a,i as r,w as _,v as S,F as y,b as h,e as E,g as u,r as c,x as P,q as l,t as p,y as j,_ as A}from"./index-BMlFpPfa.js";const F="/assets/img1-CjiyZke0.png",$="/assets/img2-CY3v75Ft.png",z="/assets/img3-C8qBPgRs.png",O="/assets/img4-DhCc55sr.png",W=`
// 解构赋值数组
const [a, b] = [1, 2, 3, 4];
...
`,K=["https://juejin.cn/post/6898630134530752520?searchId=20241225134540153E161EBA9DF8ACB408"],Q=["一、典型的 session 登陆/验证流程："],X=["① 浏览器登录发送账号密码，服务端查用户库，校验用户","② 服务端把用户登录状态存为 Session，生成一个 sessionId","③ 通过登录接口返回，把 sessionId set 到 cookie 上","④ 此后浏览器再请求业务接口，sessionId 随 cookie 带上","⑤ 服务端查 sessionId 校验 session","⑥ 成功后正常做业务处理，返回结果"],ee=["二、token 流程："],te=["① 用户登录，服务端校验账号密码，获得用户信息","② 把用户信息、token 配置编码成 token，通过 cookie set 到浏览器","③ 此后用户请求业务接口，通过 cookie 携带 token","④ 接口校验 token 有效性，进行正常业务接口处理"],se=["refresh token 流程："],oe=[{noteId:t.getRandomUniqueId(),title:"解构赋值、map、filter、空值合并运算符（??）",date:"2024-12-10",data:[{dataId:t.getRandomUniqueId(),type:"ts",code:W}]},{noteId:t.getRandomUniqueId(),title:"虚拟列表",date:"2024-12-13",data:[{dataId:t.getRandomUniqueId(),type:"html",code:Z},{dataId:t.getRandomUniqueId(),type:"ts",code:G},{dataId:t.getRandomUniqueId(),type:"scss",code:J}]},{noteId:t.getRandomUniqueId(),title:"提交代码规范",date:"2024-12-16",data:[{dataId:t.getRandomUniqueId(),type:"img",img:F}]},{noteId:t.getRandomUniqueId(),title:"单点登录",date:"2024-12-25",data:[{dataId:t.getRandomUniqueId(),type:"text",text:K,class:["link-class","title-class"]},{dataId:t.getRandomUniqueId(),type:"text",text:Q,class:["title-class"]},{dataId:t.getRandomUniqueId(),type:"img",img:$},{dataId:t.getRandomUniqueId(),type:"text",text:X},{dataId:t.getRandomUniqueId(),type:"text",text:ee,class:["title-class"]},{dataId:t.getRandomUniqueId(),type:"img",img:z},{dataId:t.getRandomUniqueId(),type:"text",text:te},{dataId:t.getRandomUniqueId(),type:"text",text:se},{dataId:t.getRandomUniqueId(),type:"img",img:O}]}],ne={class:"main-container"},le={class:"filter-class"},ae={style:{margin:"0 0 0 auto"}},ie={class:"flex-row flex-between fullWidth"},de={class:"flex-row flex-center"},re={class:"flex-row flex-center"},ue={key:0,class:"line-numbers"},ce={key:0,class:"language-ts"},pe={key:1,class:"language-html"},me=["innerHTML"],ge={key:2,class:"language-scss"},ve={key:1,class:"text-class"},ye={key:0},xe={key:1},fe=["href"],Ie={key:2,class:"img-class"},_e=["src"],he=B({__name:"index",setup(ke){N(async()=>{await k()});const m=v(),U=()=>{m.value=[...oe].reverse()},g=v({title:"",date:""}),x=v(!1),f=v(null),k=()=>{try{U(),x.value=!0,setTimeout(()=>{m.value=m.value.filter(d=>d.title.includes(g.value.title||"")&&d.date.includes(g.value.date||"")),x.value=!1,L.highlightAll()},500)}catch(d){console.log(d)}finally{f.value&&(f.value.scrollTop=0)}},q=d=>d.replace(/<[^>]*>/g,function(e){return e.replace(/</g,"&lt;").replace(/>/g,"&gt;")});return(d,e)=>{const C=c("el-input"),H=c("el-date-picker"),w=c("el-button"),D=c("Memo"),b=c("el-icon"),V=c("Calendar"),M=c("el-empty"),T=P("loading");return s(),n("div",ne,[a("div",le,[e[3]||(e[3]=a("label",null,"标题：",-1)),r(C,{modelValue:g.value.title,"onUpdate:modelValue":e[0]||(e[0]=i=>g.value.title=i),placeholder:"请输入关键字",clearable:"",style:{width:"230px"}},null,8,["modelValue"]),e[4]||(e[4]=a("label",null,"日期：",-1)),r(H,{modelValue:g.value.date,"onUpdate:modelValue":e[1]||(e[1]=i=>g.value.date=i),type:"date",placeholder:"请选择日期",editable:!1,clearable:"",format:"YYYY-MM-DD","value-format":"YYYY-MM-DD",style:{width:"230px"}},null,8,["modelValue"]),a("div",ae,[r(w,{type:"primary",onClick:k},{default:_(()=>e[2]||(e[2]=[l("查询")])),_:1})])]),S((s(),n("div",{class:"code-class",ref_key:"codeRef",ref:f},[(s(!0),n(y,null,h(m.value,i=>(s(),n("div",{key:i.noteId},[a("h3",ie,[a("span",de,[r(b,null,{default:_(()=>[r(D)]),_:1}),l(" "+p(i.title||"------"),1)]),a("span",re,[r(b,null,{default:_(()=>[r(V)]),_:1}),l(" "+p(i.date||"------"),1)])]),(s(!0),n(y,null,h(i.data,o=>(s(),n(y,{key:o.dataId},[o.type!=="img"&&o.type!=="text"?(s(),n("pre",ue,[e[11]||(e[11]=l("                        ")),a("h4",null,p(o.type),1),e[12]||(e[12]=l(`
                        ...
                        `))])):u("",!0),e[15]||(e[15]=l(`
                    `))])):u("",!0),o.type==="text"?(s(),n("div",ve,[(s(!0),n(y,null,h(o.text,(I,Y)=>{var R;return s(),n("p",{key:Y,class:j(o.class)},[(R=o.class)!=null&&R.includes("link-class")?(s(),n("span",xe,[e[16]||(e[16]=l("参考链接：")),a("a",{href:I,target:"_blank"},p(I),9,fe)])):(s(),n("span",ye,p(I),1))],2)}),128))])):u("",!0),o.type==="img"?(s(),n("div",Ie,[a("img",{src:o.img,alt:""},null,8,_e)])):u("",!0)],64))),128)),e[17]||(e[17]=a("br",null,null,-1))]))),128)),m.value&&m.value.length===0?(s(),E(M,{key:0,description:"暂无数据"})):u("",!0)])),[[T,x.value]])])}}}),Ue=A(he,[["__scopeId","data-v-44c61d58"]]);export{Ue as default};
