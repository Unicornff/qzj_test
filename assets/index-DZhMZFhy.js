import{a as T,k as g,z as r,U as $,o as a,c as v,h as e,F as L,b as S,B as b,e as V,g as k,p as H,r as M,C as N,_ as w,n as _,i as D,w as B,q as s,t as c}from"./index-CZgHeNru.js";import{P as A}from"./prism-tomorrow-CBUOVrnP.js";const U=T({name:"VirtualList",__name:"VirtualList",props:{data:{type:Array,required:!0},itemHeight:{type:Number,default:50},containerHeight:{type:Number,default:500}},setup(d){const i=d,p=g(0),h=r(()=>Math.ceil(i.containerHeight/i.itemHeight)),o=r(()=>Math.floor(p.value/i.itemHeight)),x=r(()=>o.value+h.value),l=r(()=>i.data.slice(o.value,x.value)),t=r(()=>i.data.length*i.itemHeight),u=$.lodashThrottle(n=>{p.value=n.target.scrollTop},30),f=n=>({position:"absolute",top:`${(o.value+n)*i.itemHeight}px`,width:"100%",height:`${i.itemHeight}px`});return(n,y)=>{const C=M("el-empty");return a(),v("div",{class:"virtual-list",style:b({height:`${d.containerHeight}px`,overflowY:"auto"}),onScroll:y[0]||(y[0]=(...m)=>H(u)&&H(u)(...m))},[e("div",{style:b({height:`${t.value}px`,position:"relative"})},[(a(!0),v(L,null,S(l.value,(m,I)=>(a(),v("div",{key:m.id,style:b(f(I)),class:"virtual-list-item"},[N(n.$slots,"item",{item:m,index:o.value+I},void 0,!0)],4))),128))],4),d.data.length?k("",!0):(a(),V(C,{key:0,description:"无数据"}))],36)}}}),q=w(U,[["__scopeId","data-v-4536d96a"]]),z={class:"main-container box-padding"},E={style:{display:"flex","align-items":"center"}},P={class:"code-class"},F={class:"line-numbers"},Y={class:"language-html"},j=["innerHTML"],O={class:"line-numbers"},G={class:"language-ts"},J={class:"line-numbers"},K={class:"language-scss"},W=T({__name:"index",setup(d){const i=Array.from({length:1e5},(l,t)=>({id:t,text:`Item ${t+1}`}));_(()=>{A.highlightAll()});const p=l=>l.replace(/<[^>]*>/g,function(t){return t.replace(/</g,"&lt;").replace(/>/g,"&gt;")}),h=g(`
/* 父组件 */
...
`);return(l,t)=>(a(),v("div",z,[D(q,{data:H(i)},{item:B(({item:u,index:f})=>[e("div",E,[e("strong",null,c(f+1),1),s(". "+c(u.text),1)])]),_:1},8,["data"]),e("div",P,[t[10]||(t[10]=e("h2",null,"虚拟列表关键代码",-1)),t[11]||(t[11]=e("br",null,null,-1)),t[12]||(t[12]=e("h3",null,"html",-1)),e("pre",F,[t[2]||(t[2]=s("                ")),e("code",Y,[t[0]||(t[0]=s(`
